...
/**
  ...
  * @param[in] u32Mode Pperation mode. Possible options are 
...
/**
  ...
  * @return None
  * @note This API overwirtes the register setting of the timer used to count the delay time.
...
/**
  ...
  * @return None
  * @note Timer frequency should be configured seperately by using \ref TIMER_Open API, or program registers directly
  */
...
/**
  ...
  * @return None
  * @note Timer compare value should be configured seperately by using \ref TIMER_SET_CMP_VALUE macro or program registers directly 
  */
