...
#define ADC_CMP0_INT                    (ADC_ADSR_CMPF0_Msk)        /*!< ADC comperator 0 interrupt */
#define ADC_CMP1_INT                    (ADC_ADSR_CMPF1_Msk)        /*!< ADC comperator 0 interrupt */
...
/**
  ...
  * @param[in] u32Data Specifies the compare value. Valid valure are between 0 ~ 0x3FF
  * @param[in] u32MatchCount Specifies the match count setting, valid values are vetween 1~16
  * @return None
  * @details For example, ADC_ENABLE_CMP0(ADC, 5, ADC_CMP_GREATER_OR_EQUAL_TO, 0x800, 10);
  *          Means ADC will assert comperator 0 flag if channel 5 conversion result is 
...
/**
  ...
  *          Means ADC will assert comperator 1 flag if channel 5 conversion result is 
  *          greater or equal to 0x800 for 10 times continuously.
  */                     
