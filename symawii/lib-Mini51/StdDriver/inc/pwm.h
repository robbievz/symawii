...
#define PWM_CLK_DIV_1                       (4UL) /*!< PWM clock divid by 1 */
#define PWM_CLK_DIV_2                       (0UL) /*!< PWM clock divid by 2 */
#define PWM_CLK_DIV_4                       (1UL) /*!< PWM clock divid by 4 */
#define PWM_CLK_DIV_8                       (2UL) /*!< PWM clock divid by 8 */
#define PWM_CLK_DIV_16                      (3UL) /*!< PWM clock divid by 16 */
...
#define PWM_FB0_EINT0       (PWM_PFBCON_BKEN0_Msk)                              /*!< External interrupt 0 as fault break 0 source */
#define PWM_FB0_ACMP1       (PWM_PFBCON_BKEN0_Msk | PWM_PFBCON_CPO1BKEN_Msk)    /*!< Comparator 1 as fault break 0 source */
#define PWM_FB1_EINT1       (PWM_PFBCON_BKEN1_Msk)                              /*!< External interrupt 1 as fault break 1 source */
#define PWM_FB1_ACMP0       (PWM_PFBCON_BKEN0_Msk | PWM_PFBCON_CPO0BKEN_Msk)    /*!< Comparator 0 as fault break 1 source */
#define PWM_PERIOD_INT_UNDERFLOW            (0)                         /*!< PWM period interrupt trigged if counter underflow */
#define PWM_PERIOD_INT_MATCH_CNR            (PWM_PIER_INT_TYPE_Msk)     /*!< PWM period interrupt trigged if counter match CNR */
