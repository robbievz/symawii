...
{
    i2c->I2CON = (i2c->I2CON & ~I2C_I2CON_SI_Msk) | I2C_I2CON_STO_Msk;
}
...
{
    i2c->I2CON2 &= ~I2C_I2CON2_TWOFF_EN_Msk;
}
...
{
    i2c->I2CON2 |= I2C_I2CON2_NOSTRETCH_Msk;
}
...
{
    i2c->I2CON2 &= ~I2C_I2CON2_OVER_INTEN_Msk;
}
...
{
    i2c->I2CON2 |= I2C_I2CON2_UNDER_INTEN_Msk;
}
...
{
    return ( (i2c->I2CSTATUS2 & I2C_I2CSTATUS2_WAKEUP_Msk) == I2C_I2CSTATUS2_WAKEUP_Msk ? 1:0  );
}
