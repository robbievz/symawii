...
INFO_MESSAGE = Using pre-compiled mbed distribution for K64F
...
# Special files
#
MBED_A          = $(APPLICATION_PATH)/build/mbed/$(LEVEL0)/$(TOOLCHAIN)/lib_eXmbed.a
...
#
LDFLAGS       = --specs=nosys.specs -Wl,--gc-sections --specs=nano.specs -Wl,--wrap,main -u _printf_float -u _scanf_float
